...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'mana':
				dialogue = CoolUtil.coolTextFile(Paths.txt('mana/manaDialogue'));
		}
		...
		switch(SONG.song.toLowerCase())
		{
			...
			case 'mana':
			{
					...
					var storewall:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('storewall'));
					storewall.antialiasing = true;
					storewall.scrollFactor.set(0.9, 0.9);
	...
	function manaIntro(?dialogueBox:DialogueBox):Void
	{
		inCutscene = true;
		//Plate
